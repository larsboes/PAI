...
description: "Structural analysis of complex systems — Iceberg model, Causal Loop diagrams, Archetypes, Leverage Points, and Concept Maps. Core axiom: behavior is generated by structure. USE WHEN systems thinking, causal loop, feedback loops, archetypes, leverage points, iceberg model, unintended consequences, fix the system, structural cause, why does this keep happening, recurring problem, systemic issue, second-order effects. NOT FOR incident causal chains (use RootCauseAnalysis)."
effort: high
context: fork
---
