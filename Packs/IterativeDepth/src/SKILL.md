---
name: IterativeDepth
description: "Multi-angle exploration that runs 2-8 sequential passes through the same problem from different scientific lenses to surface hidden requirements and edge cases. Best used in OBSERVE phase at Extended+ effort. USE WHEN iterative depth, explore deeper, multi-angle analysis, multiple perspectives, surface hidden requirements, all angles, blind spot check, deep dive before building, what am I missing, Extended or Deep effort, quick depth, fast angles. NOT FOR scope/zoom analysis (use ApertureOscillation)."
effort: high
---
