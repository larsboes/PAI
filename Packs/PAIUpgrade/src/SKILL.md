---
name: PAIUpgrade
description: "Generate prioritized PAI upgrade recommendations from 4 parallel threads: prior-work audit, user context, external sources (Anthropic releases, GitHub trending), and internal reflections. USE WHEN upgrade, system upgrade, check Anthropic, new Claude features, algorithm upgrade, PAI upgrade, check bookmarks, scan bookmarks, twitter bookmarks, X bookmarks, bookmarks for upgrades, what have I bookmarked, mine reflections."
effort: high
---
