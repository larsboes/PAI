...
By default, do not add a glow effect to the lines.
By default, do not add additional points to the lines.
...
By default, remove all features from the Mapbox Standard style.
...
By default, do not jump between camera angles.
