...
description: "Test LLM applications for prompt injection vulnerabilities — jailbreaks, system prompt extraction, guardrail bypass, and multi-stage attacks. Use when assessing AI application security."
---
