...
- **[root-cause-tracing](references/root-cause-tracing.md)** — Trace backward through call chains to find the original trigger
- **[defense-in-depth](references/defense-in-depth.md)** — Validate at every layer to make bugs structurally impossible
- **[stack-patterns](references/stack-patterns.md)** — Common failure modes per stack: Node/TS/Bun, Python, React, Docker, SQL, plus git bisect
- **[logging-strategies](references/logging-strategies.md)** — Effective diagnostic logging: boundary logging, structured output, correlation IDs
