---
name: BeCreative
description: "Divergent ideation using Verbalized Sampling — generates 5 internally diverse candidates and surfaces the strongest. Also expands small seed corpora into diverse N-example datasets for evals or training. USE WHEN be creative, think outside the box, brainstorm, divergent ideas, creative solutions, maximum creativity, unconventional approach, creative angle, creative framing, expand corpus, synthetic data, generate diverse examples. NOT FOR multi-cycle evolutionary ideation (use Ideate). NOT FOR factually-constrained tasks with one right answer."
effort: medium
---
