...
**Example:**
```python
callout("warning", [rt("Important: ", bold=True), rt("Don't forget this!")], "red_background")
```
...
This is the key pattern for visual comparisons.
...
column_list(
    [  # Left column
        callout("A", [rt("Concept A", bold=True)], "blue_background"),
...
```python
callout("checklist", [rt("Parent callout", bold=True)], "green_background", children=[
...
api("POST", f"{BASE}/pages", {
    ...
    "icon": {"type": "emoji", "emoji": "notebook"},
    "properties": {
...
```python
blocks = [
    callout("lightbulb", [rt("Key insight or summary", italic=True)], "purple_background"),
    p(),
    toc(),
    p(),
    h1("Section Title"),
    ...
    h2("Subsection"),
    div(),
    callout("info", [rt("Definition: ", bold=True), rt("explanation...")], "blue_background"),
    p(),
    column_list(
    ...
    p(),
    callout("checklist", [rt("Steps:", bold=True)], "green_background", children=[
        num(rt("Step 1", bold=True), rt(" - details")),
        num(rt("Step 2", bold=True), rt(" - details")),
    ]),
    p(),
    toggle([rt("Case Study", bold=True)], [
        callout("notes", [rt("Facts:", bold=True)], "gray_background", [p(rt("..."))]),
        callout("question", [rt("Question: ", bold=True), rt("...")], "default"),
        toggle([rt("Solution", bold=True)], [...]),
        callout("check", [rt("Result: ", bold=True), rt("...")], "green_background"),
    ]),
]
```
