...
description: "Structured incident investigation using 5 Whys, Fishbone/Ishikawa, Postmortem, Fault Tree, and Kepner-Tregoe IS/IS-NOT. Core axiom: humans are never root causes — the system allowed the mistake. USE WHEN root cause, RCA, 5 whys, fishbone, postmortem, incident analysis, why did this happen, fault tree, what really caused this, why does this keep failing, blameless, defect investigation, recurring bug, pre-launch risk. NOT FOR structural feedback loops (use SystemsThinking) or axiom decomposition (use FirstPrinciples)."
effort: high
context: fork
---
