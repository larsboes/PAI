---
name: Knowledge
description: "Manage the PAI Knowledge Archive — curated graph of notes across People, Companies, Ideas, and Research. Search, add, harvest, ingest URLs, find contradictions, traverse graph, and mine conversations. USE WHEN knowledge, knowledge base, search knowledge, what do we know about, archive, harvest, develop note, add to knowledge, ingest, contradictions, knowledge graph, retrieve, mine conversations. NOT FOR session/ISA context recovery (use ContextSearch)."
