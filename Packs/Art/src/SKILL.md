---
name: Art
description: "Generates visual content across 20+ formats via Flux, Nano Banana Pro, and GPT-Image-1 — illustrations, diagrams, D3 dashboards, timelines, thumbnails, icons, wallpapers, and more. USE WHEN art, illustration, diagram, flowchart, infographic, header image, thumbnail, visualize, generate image, mermaid, architecture diagram, comic, icon, blog art, D3 chart, remove background, wallpaper. NOT FOR video or animation (use Remotion). NOT FOR personal portraits."
effort: medium
---
