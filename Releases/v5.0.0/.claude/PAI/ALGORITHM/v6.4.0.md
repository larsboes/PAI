...
| `identity` | Private vault: `$VAULT_PATH/Atlas/TELOS/IDENTITY.md` (DA persona) · `$VAULT_PATH/Atlas/Personal/PERSONAL_CONTEXT.md` (principal) — NOT `USER/*_IDENTITY.md` (this fork keeps identity in the vault; see ADDITIONS.md §6). | **Surface to user; private-vault write.** |
