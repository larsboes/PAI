...
- See pi-mono repo: `packages/coding-agent/docs/extensions.md` — Official extension documentation with examples
- See pi-mono repo: `packages/coding-agent/docs/skills.md` — Official skill specification
- See pi-mono repo: `packages/coding-agent/docs/sdk.md` — SDK for programmatic access
- See pi-mono repo: `packages/coding-agent/examples/extensions/` — Working extension examples
