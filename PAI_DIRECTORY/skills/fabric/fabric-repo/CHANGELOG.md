...
- Add BEDROCK_AWS_SVCION requirement for Bedrock initialization
...
- Updated hasAWSCredentials to also check for AWS_DEFAULT_SVCION when access keys are configured in the environment
...
- Update AWS credentials checking to include AWS_DEFAULT_SVCION environment variable
