...
TELOS is {PRINCIPAL.NAME}'s life framework stored in `${VAULT_PATH}/${VAULT_TELOS}/`. It contains:
...
!`head -50 ${VAULT_PATH}/${VAULT_TELOS}/updates.md`

## View Specific TELOS File
!`FILE="$1"; cat ${VAULT_PATH}/${VAULT_TELOS}/"$FILE"`
...
All backups are stored in: `${VAULT_PATH}/${VAULT_TELOS}/Backups/`

All changes are logged in: `${VAULT_PATH}/${VAULT_TELOS}/updates.md`
