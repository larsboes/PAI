...
1. **Personal TELOS** - {PRINCIPAL.NAME}'s life context system (beliefs, goals, lessons, wisdom) at `${VAULT_PATH}/${VAULT_TELOS}/` (falls back to `${VAULT_PATH}/${VAULT_TELOS}/`)
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `${VAULT_PATH}/${VAULT_TELOS}/` |
...
All files located in `${VAULT_PATH}/${VAULT_TELOS}/`:
...
```bash
# View specific file
read ${VAULT_PATH}/${VAULT_TELOS}/GOALS.md
read ${VAULT_PATH}/${VAULT_TELOS}/BELIEFS.md

# View recent updates
read ${VAULT_PATH}/${VAULT_TELOS}/updates.md
```
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `${VAULT_PATH}/${VAULT_TELOS}/` (in CORE USER directory)
...
**Remember:** Personal TELOS files live at `${VAULT_PATH}/${VAULT_TELOS}/` (in the CORE USER directory)
