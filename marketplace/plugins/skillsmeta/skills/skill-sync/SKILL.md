...
- **Claude Code skills directory** — Personal Claude Code skills (tool name adaptations)
- **Antigravity skills directory** — Antigravity skills (when available)
- **Public repository** — Public community skills (de-personalized)

## Directory Structure

| Location | Purpose | Privacy |
|----------|---------|---------|
| Pi skills directory | Source of truth | Personal |
| Claude Code skills directory | Claude Code adapted | Personal |
| Antigravity skills directory | Antigravity adapted | Personal |
| Public repository | Community skills | Public |
...
1. **Create in pi**: Build skill in pi skills directory
...
1. **Edit in pi**: Make changes in pi skills directory
2. **Check status**:
   ```bash
...
| Mistake | Fix |
|---------|-----|
| Editing in destination directly | Always edit in pi, sync out |
...
- "I'll just quickly edit it in the destination" → Stop. Edit in pi.
